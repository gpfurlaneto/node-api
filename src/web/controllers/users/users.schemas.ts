...
export const createUserSchema = ValidatorBuilder.object(
  'body',
  true,
  ValidatorBuilder.string('email', true)
    .string('username', true)
    .string('password', true),
);

export const updateUserSchema = ValidatorBuilder.object(
  'params',
  true,
  ValidatorBuilder.number('id', true, 1),
).object(
  'body',
  true,
...
export const getUserSchema = ValidatorBuilder.object(
  'params',
  true,
  ValidatorBuilder.number('id', true),
);
